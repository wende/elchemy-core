...
map2 func taskA taskB =
    taskA
        |> andThen (\a -> taskB |> andThen (\b -> succeed (func a b)))
...
map3 func taskA taskB taskC =
    taskA
        |> andThen (\a -> taskB |> andThen (\b -> taskC |> andThen (\c -> succeed (func a b c))))
...
map4 func taskA taskB taskC taskD =
    taskA
        |> andThen (\a -> taskB |> andThen (\b -> taskC |> andThen (\c -> taskD |> andThen (\d -> succeed (func a b c d)))))
...
map5 func taskA taskB taskC taskD taskE =
    taskA
        |> andThen (\a -> taskB |> andThen (\b -> taskC |> andThen (\c -> taskD |> andThen (\d -> taskE |> andThen (\e -> succeed (func a b c d e))))))
